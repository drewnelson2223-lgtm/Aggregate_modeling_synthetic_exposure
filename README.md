...
│   ├── synthetic_exposures.pdf              # Full academic paper with validation
│   └── figures/
...
- **[Full Paper (PDF)](reports/synthetic_exposures.pdf)** - Academic paper with methodology, results, and validation
