...
```r
# Clone repository
git clone https://github.com/drewnelson2223-lgtm/aggregate-loss-modeling.git
...
**Key Panels:**
- Annual Total Losses: CP-Gamma predictions fail catastrophically, Tweedie tracks actuals
- Prediction Errors: CP-Gamma errors reach 100,000%+, Tweedie errors <3,000%
- Residual Diagnostics: Minimal bias, well-behaved residuals
- Extreme Value CDFs: Excellent GEV and GPD fit
...
- **[Full Paper (PDF)](Synthetic_exposures.pdf)** - Academic paper with complete methodology and results
